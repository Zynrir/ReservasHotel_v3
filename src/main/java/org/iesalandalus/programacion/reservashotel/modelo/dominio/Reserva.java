...
//Se ha modificado el get habitacion
    ...
    public void setRegimen(Regimen regimen) {
        if (regimen == null){
            throw new NullPointerException("ERROR: El régimen no puede ser nulo.");
        }
...
//////
    ...
    public void setNumeroPersonas(int numeroPersonas){
        ...
        if(numeroPersonas>habitacion.getNUM_MAXIMO_PERSONAS()){
    ...
    /*private void validarFechas() {
        ...
        if (fechaInicioReserva.isAfter(hoy.plusMonths(MAX_NUMERO_MESES_RESERVA))) {
        ...
        LocalDateTime maxCheckoutTime = LocalDateTime.of(fechaFinReserva, LocalTime.of(12, 0));
        if (checkOut.isAfter(maxCheckoutTime)) {
            throw new IllegalArgumentException("El checkout debe hacerse como máximo a las 12:00 horas del día en que finaliza la reserva.");
        }
    }*/
