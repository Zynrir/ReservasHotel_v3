...
public class Habitaciones implements IHabitaciones {
    ...
    public List<Habitacion> copiaProfundaHabitaciones() {
        ...
        for (Habitacion habitacion : coleccionHabitaciones) {
            ...
            if (habitacion instanceof Simple) {
                nuevaHabitacion = new Simple((Simple) habitacion);
            } else if (habitacion instanceof Doble) {
                nuevaHabitacion = new Doble((Doble) habitacion);
            } else if (habitacion instanceof Triple) {
                nuevaHabitacion = new Triple((Triple) habitacion);
            } else if (habitacion instanceof Suite) {
                nuevaHabitacion = new Suite((Suite) habitacion);
            }
            copiaHabitaciones.add(nuevaHabitacion);
        }
